...
Stress test is designed to see how YC performs under load. Test are performed
using JMeter 3.3 and involve 2 major user groups: 1) people browsing the site
