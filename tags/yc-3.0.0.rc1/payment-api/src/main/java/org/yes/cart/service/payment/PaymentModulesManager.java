...
/**
 *
 * Payment modules manages. Act as proxy to configured payment modules and gateways.
 *
...
public interface PaymentModulesManager {
     ...
     *
     * @param paymentModule module to register
     */
    void register(PaymentModule paymentModule);
