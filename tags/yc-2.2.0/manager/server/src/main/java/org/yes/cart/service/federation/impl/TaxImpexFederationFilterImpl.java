 ...
 * Time: 14:27
 */
public class TaxImpexFederationFilterImpl extends AbstractImpexFederationFilterImpl implements FederationFilter {

    private final ShopFederationStrategy shopFederationStrategy;

    public TaxImpexFederationFilterImpl(final ShopFederationStrategy shopFederationStrategy,
    ...
    public boolean isManageable(final Object object, final Class objectType) {
        ...
        return manageableShopIds.contains(tax.getShopCode());
    }
