 ...
 * Time: 19:18
 */
public class CustomerWishListSkuCodeToNameConverter implements ValueConverter {

    private final GenericDAO<Object, Long> genericDAO;

    public CustomerWishListSkuCodeToNameConverter(final GenericDAO<Object, Long> genericDAO) {
