 ...
 * Time: 8:15 AM
 */
public class ShippingSurchargePromotionAction extends AbstractShippingPromotionAction implements PromotionAction {

    private static final Logger LOG = LoggerFactory.getLogger(ShippingSurchargePromotionAction.class);
    ...
    public void perform(final Map<String, Object> context) {
        ...
        if (MoneyUtils.isPositive(surcharge)) {
            ...
            final BigDecimal promoPrice = shipping.getPrice().add(surcharge);
