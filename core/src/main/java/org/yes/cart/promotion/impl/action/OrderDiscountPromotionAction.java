 ...
 * Time: 8:15 AM
 */
public class OrderDiscountPromotionAction extends AbstractOrderPromotionAction implements PromotionAction {

    private static final Logger LOG = LoggerFactory.getLogger(OrderDiscountPromotionAction.class);
    ...
    public void perform(final Map<String, Object> context) {
        ...
        if (MoneyUtils.isFirstBiggerThanSecond(discount, BigDecimal.ZERO)) {
            ...
            BigDecimal saleDiscount = cartItemTotal.getPriceSubTotal().multiply(discount);
