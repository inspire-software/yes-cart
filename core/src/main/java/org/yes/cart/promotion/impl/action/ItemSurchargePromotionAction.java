 ...
 * Time: 8:15 AM
 */
public class ItemSurchargePromotionAction extends AbstractItemPromotionAction implements PromotionAction {

    private static final Logger LOG = LoggerFactory.getLogger(ItemSurchargePromotionAction.class);
    ...
    public void perform(final Map<String, Object> context) {
        ...
        if (MoneyUtils.isPositive(surcharge)) {
            ...
            final BigDecimal promoPrice = cartItem.getPrice().add(surcharge);
