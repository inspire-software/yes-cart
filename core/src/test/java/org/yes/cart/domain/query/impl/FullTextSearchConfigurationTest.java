    ...
    public void testCategoryQuerySearch() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                // basic search
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(101L, 104L), false,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(101L, 104L, 313L), false,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(300L), true,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(313L), true,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("This is fuzzy so we see all CC_TESTX which are in 104 a sub of 101", 1, products.size());
                assertEquals("CC_TEST4 is best match", "CC_TEST4", products.get(0).getCode());
                ...
                assertEquals("CC_TEST4 is best match", "CC_TEST4", products.get(0).getCode());
                // search by sku id
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, false,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(70L, 70L, Arrays.asList(313L), false,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(1, products.size());
                assertEquals("CC_TEST4 is best match", "CC_TEST4", products.get(0).getCode());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, Arrays.asList(101L, 104L), false,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("bender")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, Arrays.asList(104L), false,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1011L, Arrays.asList(101L, 104L), false,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("bender")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertTrue("Failed bender is availability SHOWROOM [" + context.getProductQuery().toString() + "]", !products.isEmpty());
                assertProduct(products, "BENDER");

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1011L, Arrays.asList(104L), false,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST1")));
                products = productDao.fullTextSearch(context.getProductQuery());
    ...
    public void testShopQuerySearch() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(20L, 20L, null, false,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("bender")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertFalse("The same categories assigned to 20 shop. Failed [" + context.getProductQuery().toString() + "]", products.isEmpty());
                assertEquals("BENDER is best match", "BENDER", products.get(0).getCode());

                context = searchQueryFactory.getFilteredNavigationQueryChain(30L, 30L, null, false,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("bender")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(70L, 70L, null, false,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(1, products.size());
                assertEquals("CC_TEST4 is best match", "CC_TEST4", products.get(0).getCode());
                ...
                // basic search in a sub shop
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, null, false,
                        Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("bender")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertFalse("Product must be found in 10 shop. Failed [" + context.getProductQuery().toString() + "]", products.isEmpty());
                assertEquals("BENDER is best match", "BENDER", products.get(0).getCode());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1011L, null, false,
    ...
    public void testSkuRelevancySearch() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                pContext = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, false,
    ...
    public void testBrandFaceting() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(101L), false, null);
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, false, null);
                facets = productDao.fullTextSearchNavigation(context.getProductQuery(), Collections.singletonList(brands));
                assertEquals("Failed [" + context.getProductQuery().toString() +"]", 1, facets.size());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, Arrays.asList(101L), false, null);
                facets = productDao.fullTextSearchNavigation(context.getProductQuery(), Collections.singletonList(brands));
                assertEquals("Failed [" + context.getProductQuery().toString() +"]", 1, facets.size());
    ...
    public void testPriceFaceting() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(129L, 130L, 131L, 132L), false, null);
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, Arrays.asList(129L, 130L, 131L, 132L), false, null);
    ...
    public void testCategoryBrowsing() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(101L, 200L, 123L, 2435L), false, null);
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Failed [" + context.getProductQuery().toString() + "]", 2, products.size());

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(101L, 104L), false, null);
                products = productDao.fullTextSearch(context.getProductQuery());
    ...
    public void testTagBrowsingTest() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(104L), false,
                        Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_TAG_FIELD, (List) Arrays.asList("sale")));
                products = productDao.fullTextSearch(context.getProductQuery());
    ...
    public void testSingleValueAttributeNavigation() throws Exception {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(101L, 200L), false,
                        Collections.singletonMap("MATERIAL", (List) Arrays.asList("metal")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(1, products.size());
                assertEquals("BENDER is best match", "BENDER", products.get(0).getCode());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(101L), false,
    ...
    public void testGetRangeAttributeValueNavigation() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(130L, 131L, 132L), false,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(100L), false,
                        Collections.singletonMap("WEIGHT", (List) Arrays.asList("2100-_-2500")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 0, products.size());

                // products not assigned to this category
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(100L, 101L, 102L), false,
                        Collections.singletonMap("WEIGHT", (List) Arrays.asList("2100-_-2500")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 0, products.size());
                ...
                // sub shops
                // range values are excluding high value
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, Arrays.asList(130L, 131L, 132L), false,
                        Collections.singletonMap("WEIGHT", (List) Arrays.asList("1-_-2300")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 2, products.size());
    ...
    public void testBrandNavigation() {
        ...
        getTx().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                categories.clear();
                categories.add(134L);
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, categories, false,
    ...
    public void testPriceNavigation() throws Exception {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(129L, 130L, 131L, 132L), false,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(131L, 132L), false,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(129L, 130L, 132L), false,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(20L, 20L, Arrays.asList(129L, 130L, 131L, 132L), false,
                        Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_PRICE, (List) Arrays.asList("EUR-_-0-_-1000")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(context.getProductQuery().toString(), products);
                assertTrue(context.getProductQuery().toString(), products.isEmpty());
    ...
    public void testProductAvailability() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                List<Product> products = productDao.fullTextSearch(searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, Arrays.asList(212L), false, null).getProductQuery());
                ...
                products = productDao.fullTextSearch(searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, Arrays.asList(212L), false, null).getProductQuery());
                assertEquals("Only 5 product available in 212 category", 5, products.size());
                assertNull(getProductByCode(products, "PAT_PRODUCT_ON_STOCK_ONLY_1"));
                assertNotNull(getProductByCode(products, "PAT_PRODUCT_ON_STOCK_ONLY_2"));
                assertNull(getProductByCode(products, "PAT_PRODUCT_ON_STOCK_ONLY_3"));
