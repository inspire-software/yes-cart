...
public class FullTextSearchConfigurationTest extends AbstractTestDAO {
    ...
    public void setUp()  {
        ...
        searchQueryFactory = ctx().getBean(ServiceSpringKeys.LUCENE_QUERY_FACTORY, SearchQueryFactory.class);
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("bender")));
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("Bender Bending Rodriguez")));
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L, 313L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(300L),
                        true, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(313L),
                        true, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("This is fuzzy so we see all CC_TESTX which are in 104 a sub of 101", 1, products.size());
                assertEquals("CC_TEST4 is best match", "CC_TEST4", products.get(0).getCode());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L, 313L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CATCC products")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("CC_TEST4 is in 313", 1, products.size());
                assertEquals("CC_TEST4 is best match", "CC_TEST4", products.get(0).getCode());
                // search by Sku code (misspelt)
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L, 313L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TESTX")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.SKU_ID_FIELD, (List) Arrays.asList("11004")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(1, products.size());
                assertEquals("PRODUCT5", products.get(0).getSku().iterator().next().getCode());
                //test fuzzy search
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("blender")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertFalse(products.isEmpty());
                assertTrue("BENDER is best match", Arrays.asList("BENDER", "BENDER-ua").contains(products.get(0).getCode()));
                //test search by description
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("Rodriguez Bending")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertTrue(!products.isEmpty());
                assertTrue("BENDER is best match", Arrays.asList("BENDER", "BENDER-ua").contains(products.get(0).getCode()));
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("DiMaggio")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertTrue("Must not use description in FT, it produces bad results", products.isEmpty());
                // search on empty string
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("FutureRobots")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(2, products.size());

                // search on primary attribute MATERIAL ('metal')
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("metal")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(1, products.size());
                assertEquals("BENDER is best match", "BENDER", products.get(0).getCode());
                // search on primary attribute MATERIAL with fuzzy ('metall')
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L, 104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("metall")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(1, products.size());
                assertEquals("BENDER is best match", "BENDER", products.get(0).getCode());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(70L, 70L, null, Arrays.asList(313L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(1, products.size());
                assertEquals("CC_TEST4 is best match", "CC_TEST4", products.get(0).getCode());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, null, Arrays.asList(104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST1")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, null, Arrays.asList(104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST5")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1011L, null, Arrays.asList(104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST1")));
                products = productDao.fullTextSearch(context.getProductQuery());
    ...
    public void testShopQuerySearch() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.SKU_PRODUCT_CODE_FIELD, (List) Arrays.asList("CC_TEST4")));
                products = productDao.fullTextSearch(context.getProductQuery());
    ...
    public void testFuzzySearch() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                // search by Sku code
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST99")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertFalse("Failed [" + context.getProductQuery().toString() + "]", products.isEmpty());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEZT9")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Misspelling S->Z 1 edit which is maximum allowed for SKU so only CC_TEST9 should match", 1, products.size());
                assertEquals("CC_TEST9", products.get(0).getCode());
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("CC_TEST")));
                products = productDao.fullTextSearch(context.getProductQuery());
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                pContext = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("Sobot Light")));
                ...
                pContext = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("Sobot xxl")));
                ...
                pContext = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.QUERY, (List) Arrays.asList("Sobot large")));
    ...
    public void testBrandFaceting() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L), false, null);
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 1010L, null, Arrays.asList(101L), false, null);
                facets = productDao.fullTextSearchNavigation(context.getProductQuery(), Collections.singletonList(brands));
                assertEquals("Failed [" + context.getProductQuery().toString() +"]", 1, facets.size());
    ...
    public void testTagBrowsingTest() throws InterruptedException {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_TAG_FIELD, (List) Arrays.asList("newarrival")));
                List<Product> products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_TAG_FIELD, (List) Arrays.asList("sale")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_TAG_FIELD, (List) Arrays.asList("specialpromo")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Failed [" + context.getProductQuery().toString() + "] expected 2 products", 2, products.size());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_TAG_FIELD, (List) Arrays.asList("sali")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertTrue("Failed [" + context.getProductQuery().toString() +"] expected 0 products, tags are exact match", products.isEmpty());

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(104L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_TAG_FIELD, (List) Arrays.asList("sale")));
                products = productDao.fullTextSearch(context.getProductQuery());
    ...
    public void testSingleValueAttributeNavigation() throws Exception {
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap("MATERIAL", (List) Arrays.asList("metal")));
                List<Product> products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L),
                        false, Collections.singletonMap("MATERIAL", (List) Arrays.asList("Plastik")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(1, products.size());
                assertEquals("SOBOT is best match", "SOBOT", products.get(0).getCode());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(101L),
                        false, Collections.singletonMap("MATERIAL", (List) Arrays.asList("banana")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals(0, products.size());
                //We are unable to find products manufactured from bananas
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, null,
                        false, Collections.singletonMap("SMELL", (List) Arrays.asList("apple")));
                products = productDao.fullTextSearch(context.getProductQuery());
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(130L, 131L, 132L),
                        false, Collections.singletonMap("WEIGHT", (List) Arrays.asList("1-_-2300")));
                List<Product> products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 2, products.size());

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(130L, 131L, 132L),
                        false, Collections.singletonMap("WEIGHT", (List) Arrays.asList("1-_-2310")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 3, products.size());

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(130L, 131L, 132L),
                        false, Collections.singletonMap("WEIGHT", (List) Arrays.asList("2100-_-2310")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 3, products.size());

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(130L, 131L, 132L),
                        false, Collections.singletonMap("WEIGHT", (List) Arrays.asList("2350-_-2360")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 1, products.size());

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(130L, 131L, 132L),
                        false, Collections.singletonMap("WEIGHT", (List) Arrays.asList("2340-_-2360")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 1, products.size());

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(130L, 131L, 132L),
                        false, Collections.singletonMap("WEIGHT", (List) Arrays.asList("2350-_-2380")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 1, products.size());

                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(130L, 131L, 132L),
                        false, Collections.singletonMap("WEIGHT", (List) Arrays.asList("2400-_-2490")));
                products = productDao.fullTextSearch(context.getProductQuery());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(100L),
                        false, Collections.singletonMap("WEIGHT", (List) Arrays.asList("2100-_-2500")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertEquals("Range search with query [" + context.getProductQuery() + "] incorrect", 0, products.size());
        ...
        getTx().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, categories,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.BRAND_FIELD, (List) Arrays.asList("LG")));
                ...
                categories.add(136L);
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, categories,
                        false, Collections.singletonMap(ProductSearchQueryBuilder.BRAND_FIELD, (List) Arrays.asList("Sony")));
                foundProducts = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(foundProducts);
                assertEquals(context.getProductQuery().toString(), 1, foundProducts.size());
        ...
        getTxReadOnly().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(129L, 130L, 131L, 132L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_PRICE, (List) Arrays.asList("EUR-_-12-_-15")));
                List<Product> products = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(context.getProductQuery().toString(), products);
                assertTrue(context.getProductQuery().toString(), products.isEmpty());
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(129L, 130L, 131L, 132L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_PRICE, (List) Arrays.asList("EUR-_-12-_-15.01")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(context.getProductQuery().toString(), products);
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(131L, 132L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_PRICE, (List) Arrays.asList("EUR-_-15-_-15")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(context.getProductQuery().toString(), products);
                assertTrue(context.getProductQuery().toString(), products.isEmpty());
                ...
                // prices less than 15
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(129L, 130L, 131L, 132L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_PRICE, (List) Arrays.asList("EUR-_-0-_-14")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(context.getProductQuery().toString(), products);
                assertTrue(context.getProductQuery().toString(), products.isEmpty());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(129L, 130L, 131L, 132L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_PRICE, (List) Arrays.asList("EUR-_-0-_-1000")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(context.getProductQuery().toString(), products);
                assertTrue(context.getProductQuery().toString(), !products.isEmpty());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(129L, 130L, 132L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_PRICE, (List) Arrays.asList("EUR-_-250-_-421")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(context.getProductQuery().toString(), products);
                assertTrue(context.getProductQuery().toString(), !products.isEmpty());
                assertEquals(2, products.size());
                ...
                context = searchQueryFactory.getFilteredNavigationQueryChain(10L, 10L, null, Arrays.asList(129L, 130L, 131L, 132L),
                        false, Collections.singletonMap(ProductSearchQueryBuilder.PRODUCT_PRICE, (List) Arrays.asList("USD-_-0-_-1000")));
                products = productDao.fullTextSearch(context.getProductQuery());
                assertNotNull(context.getProductQuery().toString(), products);
                assertTrue(context.getProductQuery().toString(), products.isEmpty());
