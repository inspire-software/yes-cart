...
public class TestCustomerServiceImpl extends BaseCoreDBTestCase {
    ...
    public void testFindCustomer() {
        ...
        customerService.create(customer, shopService.getById(10L));
        List<Customer> list = customerService.findCustomer(getTestName(), null, null, null, null, null);
        assertNotNull(list);
        list = customerService.findCustomer("user2", null, null, null, null, null);
        assertEquals(1, list.size());
        list = customerService.findCustomer("somedomain", null, null, null, null, null);
        assertEquals(2, list.size());
        list = customerService.findCustomer(null, "SomeFirsname", null, null, null, null);
        assertEquals(2, list.size());
        list = customerService.findCustomer(null, null, "user1LastName", null, null, null);
        assertEquals(1, list.size());
        list = customerService.findCustomer(null, null, "kintola", null, null, null);
        assertEquals(1, list.size());
        list = customerService.findCustomer(null, "SomeFirsname", null, null, null, null);
        assertEquals(2, list.size());
        list = customerService.findCustomer(null, "SomeFirsname", "Akintola", null, null, null);
        assertEquals(1, list.size());
        list = customerService.findCustomer(null, null, null, null, "tag1", null);
        assertEquals(1, list.size());
        list = customerService.findCustomer(null, null, null, null, "tag2", null);
        assertEquals(1, list.size());
        list = customerService.findCustomer(null, null, null, null, "tag3", null);
        assertEquals(1, list.size());
        list = customerService.findCustomer(null, null, null, null, null, "B2B");
        assertEquals(1, list.size());
    }
