 ...
 * Time: 14:27
 */
public class CustomerOrderPaymentUiFederationFilterImpl implements FederationFilter {

    private final ShopFederationStrategy shopFederationStrategy;

    public CustomerOrderPaymentUiFederationFilterImpl(final ShopFederationStrategy shopFederationStrategy) {
