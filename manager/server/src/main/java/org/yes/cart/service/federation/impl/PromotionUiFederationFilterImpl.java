 ...
 * Time: 14:27
 */
public class PromotionUiFederationFilterImpl implements FederationFilter {

    private final ShopFederationStrategy shopFederationStrategy;

    public PromotionUiFederationFilterImpl(final ShopFederationStrategy shopFederationStrategy) {
