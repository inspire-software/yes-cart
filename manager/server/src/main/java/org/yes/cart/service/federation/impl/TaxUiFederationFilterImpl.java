 ...
 * Time: 14:27
 */
public class TaxUiFederationFilterImpl implements FederationFilter {

    private final ShopFederationStrategy shopFederationStrategy;

    public TaxUiFederationFilterImpl(final ShopFederationStrategy shopFederationStrategy) {
