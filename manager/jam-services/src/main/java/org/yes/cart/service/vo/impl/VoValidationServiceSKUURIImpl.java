 ...
 * Time: 15:31
 */
public class VoValidationServiceSKUURIImpl extends AbstractVoValidationServiceSubjectCodeFieldImpl implements VoValidationService {

    private final ProductService productService;

    public VoValidationServiceSKUURIImpl(final ProductService productService) {
