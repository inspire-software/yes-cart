 ...
 * Time: 14:27
 */
public class SkuWarehouseImpexFederationFilterImpl extends AbstractImpexFederationFilterImpl implements FederationFilter {

    private final ShopFederationStrategy shopFederationStrategy;

    public SkuWarehouseImpexFederationFilterImpl(final ShopFederationStrategy shopFederationStrategy,
