 ...
 * Time: 14:27
 */
public class CarrierUiFederationFilterImpl implements FederationFilter {

    private final ShopFederationStrategy shopFederationStrategy;
    private final DtoCarrierService carrierService;

    public CarrierUiFederationFilterImpl(final ShopFederationStrategy shopFederationStrategy,
