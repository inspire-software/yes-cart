 ...
 * Time: 17:43
 */
public class GenericDeliveryTransitionManualAction implements OrderFlowAction {

    private final DtoCustomerOrderService dtoCustomerOrderService;
    private final String targetState;

    public GenericDeliveryTransitionManualAction(final DtoCustomerOrderService dtoCustomerOrderService,
    ...
    public Result doTransition(final String deliverynum, final Object params) {
        ...
        return dtoCustomerOrderService.updateDeliveryStatusManual(map.get("ordernum"), deliverynum, currentState, targetState, message, map.get("clientMessage"));
    }
}
