...
public interface VoContentService {
     ...
     * @throws Exception errors
     */
    VoContentWithBody getContentById(long id) throws Exception;
     ...
     * @throws Exception errors
     */
    VoContentWithBody updateContent(VoContentWithBody voContent)  throws Exception;
     ...
     * @throws Exception errors
     */
    VoContentWithBody createContent(VoContent voContent)  throws Exception;
     ...
     * @throws Exception errors
     */
    void removeContent(long id) throws Exception;
     ...
     * @throws Exception errors
     */
    List<VoAttrValueContent> updateContentAttributes(List<MutablePair<VoAttrValueContent, Boolean>> vo) throws Exception;
     ...
     * @throws Exception errors
     */
    List<VoContentBody> updateContentBody(List<VoContentBody> vo) throws Exception;
