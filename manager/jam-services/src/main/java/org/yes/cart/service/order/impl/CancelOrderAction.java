 ...
 * Time: 17:45
 */
public class CancelOrderAction implements OrderFlowAction {

    private final DtoCustomerOrderService dtoCustomerOrderService;

    public CancelOrderAction(final DtoCustomerOrderService dtoCustomerOrderService) {
    ...
    public Result doTransition(final String orderNum, final Object params) {
        ...
        return dtoCustomerOrderService.updateOrderSetCancelled(orderNum, map.get("message"), map.get("clientMessage"));
    }
}
