// ^C^V because of https://github.com/valor-software/ng2-bootstrap/issues/750

import {
  Component, OnInit, Input, Output, ElementRef, EventEmitter, Self, Renderer, forwardRef, Provider
  } from '@angular/core';
import {NgFor, NgIf, NG_VALUE_ACCESSOR} from '@angular/common';
...
const PAGINATION_ACCESSOR = new Provider(
  NG_VALUE_ACCESSOR, {useExisting: forwardRef(() => PaginationComponent), multi: true});

/* tslint:disable */
@Component({
  selector: 'pagination[ngModel]',
  template: PAGINATION_TEMPLATE,
  directives: [NgFor, NgIf, REACTIVE_FORM_DIRECTIVES],
  providers: [PAGINATION_ACCESSOR]
})
/* tslint:enable */
