...
import { ShopAttributesComponent, ShopCarrierComponent, ShopCatalogMinComponent, ShopCurrencyComponent,
...
@NgModule({
    ...
    declarations: [
      ShopAttributesComponent, ShopCarrierComponent, ShopCatalogMinComponent, ShopCurrencyComponent,
      ShopFulfilmentCentreComponent, ShopLanguageComponent, ShopLocationComponent, ShopMainComponent,
      ShopPaymentGatewaysComponent, ShopSEOComponent, ShopUrlComponent, ShopAliasComponent,
