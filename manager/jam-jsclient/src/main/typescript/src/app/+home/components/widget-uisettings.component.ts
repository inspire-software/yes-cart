...
export class WidgetUiSettingsComponent {
  ...
  public uiLangReadOnly:boolean = true;
  public uiSettingReadOnly:boolean = true;
  public uiSettingProperty:string = '';
  ...
  set uiLang(lang:string) {
    if (['uk','ru','en','de'].indexOf(lang) !== -1) {
      ...
      StorageUtil.saveValue('ADM_UI_LANG', lang);
    }
  }
  ...
  set uiSetting(value:number) {
    ...
    StorageUtil.saveValue(cookieName, ''+value);
  }
