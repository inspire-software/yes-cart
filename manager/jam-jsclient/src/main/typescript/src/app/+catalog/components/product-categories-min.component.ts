...
export class ProductCategoryMinComponent implements OnInit, OnDestroy {
  ...
  public assigned:Array<ProductCategoryVO> = null;
        ...
        if (current > 0) {
          ...
          this._categoryService.getBranchesCategoriesPaths(_assignedIds).subscribe(
            cats => {
              ...
              this._categoryService.getBranchCategories(0, cats).subscribe(
                cats => {
