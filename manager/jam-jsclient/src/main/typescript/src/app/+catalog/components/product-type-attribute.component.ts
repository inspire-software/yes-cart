...
@Component({
  selector: 'cw-product-type-attribute',
...
export class ProductTypeAttributeComponent implements OnInit, OnChanges {
  ...
  public objectAttributesRemove:Array<number>;
  public objectAttributesEdit:Array<number>;
  private _attributeFilter:string;
  public filteredObjectAttributes:Array<ProductTypeAttrVO>;
  ...
  public selectedRow:ProductTypeAttrVO;

  public attributeToEdit:ProductTypeAttrVO;
  public enableEditRanges:boolean = false;
  public rangeNav:boolean = false;
  public showRanges:boolean = false;
  public editRanges:boolean = false;
  public duplicateAttribute:boolean = false;
  ...
  onNewAttributeSelected(event:AttributeVO) {
  ...
  onRowDelete(row:ProductTypeAttrVO) {
  ...
  onRowEdit(row:ProductTypeAttrVO) {
  ...
  onSelectRow(row:ProductTypeAttrVO) {
  ...
  getSearchFlags(row:ProductTypeAttrVO) {
    let flags = '';
    if (row.store) {
  ...
  onNavRangeDelete(range:ProductTypeAttrNavigationRangeVO) {
