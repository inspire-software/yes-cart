...
export class ContentComponent implements OnInit, OnDestroy {
  ...
  public visibleContentBodies: Array<ContentBodyVO> = [];
  public visibleLanguages: Array<string> = [];
  ...
  public selectedRow:AttrValueContentVO;
  ...
  public bodyEdit:ContentBodyVO;
  public bodyEditChange:string;
  ...
  onSelectRow(row:AttrValueContentVO) {
  ...
  onContentParentSelected(event:FormValidationEvent<ContentVO>) {
  ...
  onCMSEditRaw(body:ContentBodyVO) {
  ...
  getVisibleContentBodies(bodies:Array<ContentBodyVO>):Array<ContentBodyVO> {
  ...
  isBodyVisible(body:ContentBodyVO):boolean {
    return this.visibleLanguages.includes(body.lang);
  }

  onBodyEnable(body:ContentBodyVO) {
  ...
  getCMSPreview(body:ContentBodyVO) {
