...
export class ParameterValuesComponent implements OnInit, OnChanges {
  ...
  public filteredObjectAttributes:Array<PaymentGatewayParameterVO>;
  ...
  public selectedRow:PaymentGatewayParameterVO;

  public attributeToEdit:PaymentGatewayParameterVO;
  public expandDefault:boolean = true;
   ...
   */
  onRowDelete(row:PaymentGatewayParameterVO) {
    LogUtil.debug('ParameterValuesComponent onRowDelete handler', row);
    this.deleteConfirmationModalDialog.show();
  }

  onRowEdit(row:PaymentGatewayParameterVO) {
  ...
  onSelectRow(row:PaymentGatewayParameterVO) {
  ...
  isEditedAttribute(row:PaymentGatewayParameterVO):boolean {
  ...
  getAttributeColor(row:PaymentGatewayParameterVO, removed:string, edited:string, added:string, prestine:string) {
  ...
  getDisplayValue(row:PaymentGatewayParameterVO):string {
    if (row.value != null) {
