...
export class QueryComponent implements OnInit {
  ...
  public cluster:Array<ClusterNodeVO> = [];
  public supportedQueries:Array<Pair<string, Array<string>>> = [];

  public selectedNode:string = null;
  public selectedTabType:string = 'sql-core';
  ...
  onRunHandler() {
    ...
    this.loading = true;
    this._systemService.runQuery(node, data.qtype, data.query).subscribe(res => {
  ...
  private getClusterInfo() {
    ...
    this._systemService.getClusterInfo().subscribe(cluster => {
      ...
      this._systemService.supportedQueries().subscribe(supportedQueries => {
