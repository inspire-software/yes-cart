...
export class CountryComponent implements OnInit, OnDestroy {
  ...
  public stateSort:Pair<string, boolean> = { first: 'stateCode', second: false };

  public selectedState:StateVO = null;
  ...
  onPageSelectedState(page:number) {
    LogUtil.debug('CountryComponent onPageSelectedState', page);
  }

  onSortSelectedState(sort:Pair<string, boolean>) {
