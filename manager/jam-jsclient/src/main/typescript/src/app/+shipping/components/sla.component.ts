...
export class SlaComponent implements OnInit, OnDestroy {
  ...
  public availablePgs:Array<PaymentGatewayInfoVO> = [];
  public supportedPgs:Array<PaymentGatewayInfoVO> = [];

  private _fcs:any = {};

  public availableFcs:Array<FulfilmentCentreInfoVO> = [];
  public supportedFcs:Array<FulfilmentCentreInfoVO> = [];
    ...
    supported.forEach(code => {
      if (this._fcs.hasOwnProperty(code)) {
        ...
        labels.push({
          ...
          multipleShippingSupported: false, forceBackorderDeliverySplit: false, forceAllDeliverySplit: false,
