...
export class CarrierComponent implements OnInit, OnDestroy {
  ...
  public supportedShops:Array<Pair<ShopVO, CarrierShopLinkVO>> = [];

  public delayedChange:Future;

  public carrierForm:any;

  public slaFilter:string;
  public slaSort:Pair<string, boolean> = { first: 'name', second: false };

  public selectedSla:CarrierSlaInfoVO = null;
  ...
  onPageSelectedSla(page:number) {
    LogUtil.debug('CarrierComponent onPageSelectedSla', page);
  }

  onSortSelectedSla(sort:Pair<string, boolean>) {
