...
export class AddressBookComponent implements OnInit, OnDestroy {
  ...
  public addressEdit:AddressVO = null;
  public addressBook:AddressBookVO = null;
  public countries:LocationVO[] = [];
  public states:LocationVO[] = [];
  public formattingShopId:number = 0;
  ...
  onFormatShopChange(event:any) {

    this.reloadAddressbook();

  }

  onRowAddSelected():void {
  ...
  onRowEditSelected(address:AddressVO) {
    if (address != null) {
  ...
  reloadCountries(addressType:string):void {
  ...
  reloadStates(address:AddressVO):void {
  ...
  onEditConfirmationResult(modalresult: ModalResult) {
    ...
    if (ModalAction.POSITIVE === modalresult.action) {
      ...
      if (this.addressEdit != null) {
        ...
        this._customerService.saveAddress(this.addressEdit).subscribe(res => {
          LogUtil.debug('AddressBookComponent saveAddress', this.addressEdit, res);
  ...
  onRowDeleteSelected(address:AddressVO) {
    if (address != null) {
  ...
  onDeleteConfirmationResult(modalresult: ModalResult) {
    ...
    if (ModalAction.POSITIVE === modalresult.action) {
      ...
      if (this.addressEdit != null) {
        ...
        this._customerService.removeAddress(this.addressEdit).subscribe(res => {
          LogUtil.debug('AddressBookComponent removeAddress', this.addressEdit, res);
          this.addressEdit = null;
          this.reloadAddressbook();
        });
      }
  ...
  getFormattedAddress(address:AddressVO) {
  ...
  private reloadAddressbook():void {
    ...
    if (this._customer != null && this._customer.customerId > 0 && this._shops != null && this._shops.length > 0) {
      ...
      this._customerService.getAddressBook(this._customer, this.formattingShopId, lang).subscribe(rez => {
