...
export class ShopCurrencyComponent implements OnInit {
  ...
  public shopSupportedCurrenciesVO:ShopSupportedCurrenciesVO;
  public curr:ShopSupportedCurrenciesVO;
  ...
  onRefreshHandler() {
    ...
    if (this.shop.shopId > 0) {
      this.loading = true;
      this._shopService.getShopCurrencies(this.shop.shopId).subscribe(shopSupportedCurrenciesVO => {
        this.shopSupportedCurrenciesVO = Util.clone(shopSupportedCurrenciesVO);
        this.curr = Util.clone(shopSupportedCurrenciesVO);
        this.removeItems(this.curr.all, this.curr.supported);
        this.changed = false;
