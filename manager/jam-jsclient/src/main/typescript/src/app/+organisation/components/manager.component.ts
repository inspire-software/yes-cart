...
export class ManagerComponent implements OnInit, OnDestroy {
  ...
  public availableShops:Array<Pair<ShopVO, ManagerShopLinkVO>> = [];
  public supportedShops:Array<Pair<ShopVO, ManagerShopLinkVO>> = [];

  public availableRoles:Array<Pair<RoleVO, ManagerRoleLinkVO>> = [];
  public supportedRoles:Array<Pair<RoleVO, ManagerRoleLinkVO>> = [];

  public availableSuppliers:Array<Pair<ProductSupplierCatalogVO, ManagerSupplierCatalogVO>> = [];
  public supportedSuppliers:Array<Pair<ProductSupplierCatalogVO, ManagerSupplierCatalogVO>> = [];

  public delayedChange:Future;

  public managerForm:any;

  public mustSelectShop:boolean = false;

  public newSupplier:ProductSupplierCatalogVO;
  @ViewChild('editNewSupplierCode')
  private editNewSupplierCode:ModalComponent;

  public newSupplierForm:any;
