...
export class OrganisationRoleComponent implements OnInit, OnDestroy {
  ...
  public viewMode:string = OrganisationRoleComponent.ROLES;

  public roles:Array<RoleVO> = [];
  public roleFilter:string;
  public roleSort:Pair<string, boolean> = { first: 'description', second: false };

  public selectedRole:RoleVO;

  public roleEdit:RoleVO;
  ...
  onSaveHandler() {
    ...
    if (this.validForSave && this.changed) {
      ...
      if (this.roleEdit != null) {
        ...
        this.loading = true;
        this._roleService.saveRole(this.roleEdit).subscribe(
          rez => {
  ...
  onDeleteConfirmationResult(modalresult: ModalResult) {
    ...
    if (ModalAction.POSITIVE === modalresult.action) {
      ...
      if (this.selectedRole != null) {
        ...
        this.loading = true;
        this._roleService.removeRole(this.selectedRole).subscribe(res => {
  ...
  private getAllRoles() {
    this.loading = true;
    this._roleService.getAllRoles().subscribe( allroles => {
