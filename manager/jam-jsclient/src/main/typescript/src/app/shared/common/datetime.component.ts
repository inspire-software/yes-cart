...
export class DateTimeComponent {
  ...
  set valueInternal(value: any) {
    this._valueInternal = value instanceof Date ? UiUtil.toDateString(value, true) : value;
    ...
    LogUtil.debug('DateTimeComponent valueInternal', value, this._valueInternal, this._valueTime);
  }
