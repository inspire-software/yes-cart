...
export class CustomersComponent implements OnInit, OnDestroy {
  ...
  public filteredCustomers:Array<CustomerInfoVO>;
  ...
  onSelectRow(row:CustomerInfoVO) {
  ...
  getPolicyLabels(row:CustomerInfoVO) {
    let out = '';
    if (row.customerType) {
  ...
  getShopNames(row:CustomerInfoVO):CustomerShop[] {
