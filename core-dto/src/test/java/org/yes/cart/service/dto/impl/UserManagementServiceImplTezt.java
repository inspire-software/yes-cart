...
public class UserManagementServiceImplTezt extends BaseCoreDBTestCase {
    ...
    public void testResetPassword() throws Exception {
        managementService.addUser("bender4@futurama.com", "Bender4", "Rodríguez4", null, null, null, "SHOIP1");
        ...
        String newPwdHash = managerService.findByEmail("bender4@futurama.com").getPassword();
        String newPwdHash2 = managerService.findByEmailPartial("bender4@futura").get(0).getPassword();
    ...
    public void testGrantRole() throws Exception {
        ...
        getTx().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                try {
                    managementService.addUser("bende11r@futurama.com", "Bender", "Rodríguez", null, null, null, "SHOIP1");
    ...
    public void testRevokeRole() throws Exception {
        ...
        getTx().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                try {
                    managementService.addUser("bender12@futurama.com", "Bender", "Rodríguez", null, null, null, "SHOIP1");
    ...
    public void testDeleteRole() throws Exception {
        ...
        getTx().execute(new TransactionCallbackWithoutResult() {
            public void doInTransactionWithoutResult(TransactionStatus status) {
                try {
                    managementService.addUser("bender13@futurama.com", "Bender", "Rodríguez", null, null, null, "SHOIP1");
