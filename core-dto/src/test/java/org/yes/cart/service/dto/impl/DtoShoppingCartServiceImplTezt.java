...
public class DtoShoppingCartServiceImplTezt extends BaseCoreDBTestCase {
    ...
    @Test
    public void testBasicAmendmentCartSequenceRegistered() throws Exception {
        ...
        assertEquals(customerOrder.getCustomer().getLogin(), reassembledCart.getCustomerLogin());
    ...
    @Test
    public void testBasicAmendmentCartSequenceGuest() throws Exception {

        ShoppingCart shoppingCart = getShoppingCart2(null, true);

        Customer customer = createCustomerB2G(shoppingCart.getGuid());
        ...
        assertNull(customerOrder.getCustomer());
        assertEquals(customerOrder.getOrdernum(), reassembledCart.getCustomerLogin());
        assertEquals(customerOrder.getCurrency(), reassembledCart.getCurrencyCode());
        assertEquals(customerOrder.getLocale(), reassembledCart.getCurrentLocale());
        assertEquals(customerOrder.getOrdernum(), reassembledCart.getOrdernum());
