...
public class DtoProductAssociationServiceImplTezt extends BaseCoreDBTestCase {
    ...
    @Before
    public void setUp() {
        dtoProductAssociationService = (DtoProductAssociationService) ctx().getBean(DtoServiceSpringKeys.DTO_PRODUCT_ASSOCIATION_SERVICE);
        dtoAssociationService = (DtoAssociationService) ctx().getBean(DtoServiceSpringKeys.DTO_ASSOCIATION_SERVICE);
