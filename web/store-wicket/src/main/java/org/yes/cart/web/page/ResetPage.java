...
import org.yes.cart.web.page.component.customer.auth.ResetPanel;
 ...
 */
@RequireHttps
public class ResetPage extends AbstractWebPage {
    ...
    public IModel<String> getPageTitle() {
        return new StringResourceModel("reset",this);
    }
