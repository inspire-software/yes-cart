 ...
 * Time: 10:56
 */
public class MultiDeliveryMapAdapter extends XmlAdapter<MultiDeliveryMapAdapter.AdaptedMap, Map<String, Boolean>> {

    @XmlType(name = "multi-delivery")
    ...
    @XmlType(name = "carrier-sla-multi-delivery")
