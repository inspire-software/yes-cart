...
@Dto
@XmlRootElement(name = "content-attribute")
public class AttrValueContentRO implements Serializable {
    ...
    @DtoField(value = "content.contentId", readOnly = true)
