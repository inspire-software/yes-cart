 ...
 * Time: 17:58
 */
public class ContentFileServiceImpl extends AbstractImageServiceImpl implements AttributableImageService {

    public ContentFileServiceImpl(final CacheManager cacheManager) {
        super(cacheManager);
    }
