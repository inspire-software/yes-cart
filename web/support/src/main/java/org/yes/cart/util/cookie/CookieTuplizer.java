...
public interface CookieTuplizer extends Serializable {
     ...
     *
     * @throws UnableToCookielizeObjectException thrown when object cannot be converted to Cookies.
     */
     ...
     *
     * @throws UnableToObjectizeCookieException when Cookies cannot be converted to desired object.
     */
