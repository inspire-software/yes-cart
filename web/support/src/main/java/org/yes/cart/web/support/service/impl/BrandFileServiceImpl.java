 ...
 * User: Denis Pavlov
 */
public class BrandFileServiceImpl extends AbstractImageServiceImpl implements AttributableImageService {

    public BrandFileServiceImpl(final CacheManager cacheManager) {
        super(cacheManager);
    }
    ...
    protected String getAttributePrefix(final Object attributableOrStrategy) {
        return AttributeNamesKeys.Brand.BRAND_FILE_PREFIX;
    }
