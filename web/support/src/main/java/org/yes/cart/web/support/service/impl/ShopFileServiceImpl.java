 ...
 * User: Denis Pavlov
 */
public class ShopFileServiceImpl extends AbstractImageServiceImpl implements AttributableImageService {

    public ShopFileServiceImpl(final CacheManager cacheManager) {
        super(cacheManager);
    }
