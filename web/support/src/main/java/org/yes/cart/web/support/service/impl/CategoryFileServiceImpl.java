 ...
 * User: Denis Pavlov
 */
public class CategoryFileServiceImpl extends AbstractImageServiceImpl implements AttributableImageService {

    public CategoryFileServiceImpl(final CacheManager cacheManager) {
        super(cacheManager);
    }
