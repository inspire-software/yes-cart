...
public class PaymentModuleImpl implements PaymentModule {
    ...
    /**
     * IoC manager register.
     *
     * @param paymentModulesManager manager
     */
    public void setPaymentModulesManager(final PaymentModulesManager paymentModulesManager) {
        paymentModulesManager.register(this);
    }
