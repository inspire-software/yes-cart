 ...
 * Time: 11:22
 */
public class AbstractPaySeraPaymentGatewayImplTest {
    ...
    public void testGetParameterValue() throws Exception {
        ...
        mockery.checking(new Expectations() {{
            ...
            allowing(visitor).getConfiguration("label"); will(returnValue("PayPal"));
        }});

        final AbstractPaySeraPaymentGatewayImpl pg = new AbstractPaySeraPaymentGatewayImpl() {
            @Override
