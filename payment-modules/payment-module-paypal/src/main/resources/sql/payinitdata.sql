...
'API_USER_NAME',
'!!!PROVIDE VALUE!!!'
, 'Api user name', 'Api user name', 1, 'SecureString');

INSERT INTO TPAYMENTGATEWAYPARAMETER (PAYMENTGATEWAYPARAMETER_ID, PG_LABEL, P_LABEL, P_VALUE, P_NAME, P_DESCRIPTION, SECURE_ATTRIBUTE, BUSINESSTYPE)
VALUES (14251, 'payPalProPaymentGateway',
'API_USER_PASSWORD',
'!!!PROVIDE VALUE!!!'
, 'Api user password', 'Api user password', 1, 'SecureString');

INSERT INTO TPAYMENTGATEWAYPARAMETER (PAYMENTGATEWAYPARAMETER_ID, PG_LABEL, P_LABEL, P_VALUE, P_NAME, P_DESCRIPTION, SECURE_ATTRIBUTE, BUSINESSTYPE)
VALUES (14252, 'payPalProPaymentGateway',
'SIGNATURE',
'!!!PROVIDE VALUE!!!'
, 'Signature', 'Signature', 1, 'SecureString');
...
'PPB_USER',
'!!!PROVIDE VALUE!!!'
, 'Api user name', 'Your PayPal ID or an email address associated with your PayPal account. Email addresses must be confirmed', 1, 'SecureString');
