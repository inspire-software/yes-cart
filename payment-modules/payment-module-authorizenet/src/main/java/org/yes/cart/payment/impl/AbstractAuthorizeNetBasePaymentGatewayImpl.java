 ...
 */
public abstract class AbstractAuthorizeNetBasePaymentGatewayImpl implements ConfigurablePaymentGateway, PaymentGateway {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractAuthorizeNetBasePaymentGatewayImpl.class);
