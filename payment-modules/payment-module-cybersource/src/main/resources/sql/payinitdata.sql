...
INSERT INTO TPAYMENTGATEWAYPARAMETER (PAYMENTGATEWAYPARAMETER_ID, PG_LABEL, P_LABEL, P_VALUE, P_NAME, P_DESCRIPTION, SECURE_ATTRIBUTE)
VALUES (12158, 'cyberSourcePaymentGateway',
'proxyHost',
''
, 'Proxy host', 'Proxy host', 1);

INSERT INTO TPAYMENTGATEWAYPARAMETER (PAYMENTGATEWAYPARAMETER_ID, PG_LABEL, P_LABEL, P_VALUE, P_NAME, P_DESCRIPTION, SECURE_ATTRIBUTE)
VALUES (12159, 'cyberSourcePaymentGateway',
'proxyPort',
''
, 'Proxy port', 'Proxy port', 1);

INSERT INTO TPAYMENTGATEWAYPARAMETER (PAYMENTGATEWAYPARAMETER_ID, PG_LABEL, P_LABEL, P_VALUE, P_NAME, P_DESCRIPTION, SECURE_ATTRIBUTE)
VALUES (12160, 'cyberSourcePaymentGateway',
'proxyUser',
''
, 'Proxy user', 'Proxy user', 1);

INSERT INTO TPAYMENTGATEWAYPARAMETER (PAYMENTGATEWAYPARAMETER_ID, PG_LABEL, P_LABEL, P_VALUE, P_NAME, P_DESCRIPTION, SECURE_ATTRIBUTE, BUSINESSTYPE)
VALUES (12161, 'cyberSourcePaymentGateway',
'proxyPassword',
''
, 'Proxy password', 'Proxy password', 1, 'SecureString');
