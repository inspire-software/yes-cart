    ...
    create table TATTRIBUTE (
        ...
        SECURE_ATTRIBUTE smallint default 0 not null,
    ...
    create table TCUSTOMERORDERDELIVERYDET (
        ...
        CONFIGURABLE smallint DEFAULT 0,
        NOT_SOLD_SEPARATELY smallint DEFAULT 0,
        B2B_REMARKS varchar(255),
        DELIVERY_REMARKS varchar(255),
        DELIVERY_EST_MIN timestamp,
        DELIVERY_EST_MAX timestamp,
    ...
    create table TPRODUCT (
        ...
        NOT_SOLD_SEPARATELY smallint not null default 0,
        NAME varchar(255) not null,
        DISPLAYNAME varchar(4000),
        DESCRIPTION varchar(4000),
        TAG varchar(255),
    ...
    ALTER TABLE TCONTENT ALTER COLUMN CONTENT_ID RESTART WITH 100000;
    ALTER TABLE TCONTENTATTRVALUE ALTER COLUMN ATTRVALUE_ID RESTART WITH 100000;
    ...
    ALTER TABLE TPRODUCTOPT ALTER COLUMN PRODUCTOPT_ID RESTART WITH 100000;
    ...
    ALTER TABLE TSKUPRICERULE ALTER COLUMN SKUPRICERULE_ID RESTART WITH 100000;
    ...
    ALTER TABLE TJOBDEFINITION ALTER COLUMN JOBDEFINITION_ID RESTART WITH 100000;
    ALTER TABLE TJOB ALTER COLUMN JOB_ID RESTART WITH 100000;
