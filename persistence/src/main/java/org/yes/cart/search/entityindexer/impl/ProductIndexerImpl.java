...
public class ProductIndexerImpl implements ProductIndexer {
    ...
    private final GenericFTSCapableDAO<Product, Long, Query> productDao;
     ...
     */
    public ProductIndexerImpl(final GenericFTSCapableDAO<Product, Long, Query> productDao, final int queueLength, final int threadPoolSize) {
