 ...
 * Time: 2:17:57 PM
 */
public class RequestHeaderTuplizerImpl extends AbstractCryptedTuplizerImpl implements CartTuplizer<HttpServletRequest, HttpServletResponse> {
     ...
     */
    public RequestHeaderTuplizerImpl(final String keyRingPassword,
                                     final int chunkSize,
    ...
    private ShoppingCart toObject(final Map<String, List<String>> headers) throws CartDetuplizationException {

        final String input = assembleStringRepresentationOfObjectFromCookies(headers);
        return (ShoppingCart) toObject(input);
