 ...
 *       &lt;sequence>
 *         &lt;element name="attribute" type="{}product-type-attributeType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class ProductTypeAttributesType {
    ...
    protected List<ProductTypeAttributeType> attribute;
     ...
     * 
     */
    public List<ProductTypeAttributeType> getAttribute() {
        if (attribute == null) {
            attribute = new ArrayList<ProductTypeAttributeType>();
        }
