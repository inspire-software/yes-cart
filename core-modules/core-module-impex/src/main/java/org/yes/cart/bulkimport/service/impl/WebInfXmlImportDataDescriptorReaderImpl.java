 ...
 * Time: 14:04
 */
public class WebInfXmlImportDataDescriptorReaderImpl implements DataDescriptorReader<ImportDescriptor>, ApplicationContextAware {
    ...
    public WebInfXmlImportDataDescriptorReaderImpl(final String pathToImportDescriptors) {
