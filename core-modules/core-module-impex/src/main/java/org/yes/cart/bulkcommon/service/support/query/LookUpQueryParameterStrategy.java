...
package org.yes.cart.bulkcommon.service.support.query;
 ...
 * Time: 8:43 AM
 */
public interface LookUpQueryParameterStrategy<ED extends ImpExDescriptor, TP extends ImpExTuple, VA> {
     ...
     * @return query object
     */
    LookUpQuery getQuery(final ED descriptor,
