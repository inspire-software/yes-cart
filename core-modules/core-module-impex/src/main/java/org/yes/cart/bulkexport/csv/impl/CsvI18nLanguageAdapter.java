 ...
 * Time: 16:30
 */
public class CsvI18nLanguageAdapter implements CsvValueAdapter {
    ...
    public Object fromRaw(final Object rawValue, final String requiredType, final CsvImpExColumn csvImpExColumn, final CsvImpExTuple tuple) {
        if (rawValue instanceof I18NModel) {
            final String language = csvImpExColumn.getLanguage();
            return ((I18NModel) rawValue).getValue(language);
        }
        return null;
    }
}
