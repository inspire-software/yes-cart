...
/**
 * <p>Java class for customer-shopsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="customer-shopsType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="shop" type="{}customer-shopType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "customer-shopsType", propOrder = {
    "shop"
})
public class CustomerShopsType {

    protected List<CustomerShopType> shop;
     ...
     * {@link CustomerShopType }
     * 
     * 
     */
    public List<CustomerShopType> getShop() {
        if (shop == null) {
            shop = new ArrayList<CustomerShopType>();
        }
        return this.shop;
    }
