 ...
 * Time: 14:04
 */
public class WebInfXmlExportDataDescriptorReaderImpl implements DataDescriptorReader<ExportDescriptor>, ApplicationContextAware {

    private static final Logger LOG = LoggerFactory.getLogger(WebInfXmlExportDataDescriptorReaderImpl.class);
    ...
    public WebInfXmlExportDataDescriptorReaderImpl(final String pathToExportDescriptors) {
