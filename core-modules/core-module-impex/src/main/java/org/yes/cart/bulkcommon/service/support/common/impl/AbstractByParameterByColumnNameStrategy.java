 ...
 * Time: 9:29 AM
 */
public abstract class AbstractByParameterByColumnNameStrategy<ED extends ImpExDescriptor, TP extends ImpExTuple, VA>
        implements LookUpQueryParameterStrategy<ED, TP, VA> {
