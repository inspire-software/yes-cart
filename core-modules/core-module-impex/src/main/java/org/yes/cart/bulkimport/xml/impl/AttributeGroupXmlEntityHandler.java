 ...
 * Time: 22:23
 */
public class AttributeGroupXmlEntityHandler extends AbstractXmlEntityHandler<AttributeGroupType, AttributeGroup> implements XmlEntityImportHandler<AttributeGroupType> {
