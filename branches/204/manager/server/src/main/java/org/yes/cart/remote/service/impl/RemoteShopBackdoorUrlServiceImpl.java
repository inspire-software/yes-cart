...
import org.yes.cart.remote.service.RemoteShopBackdoorUrlService;
 ...
 * Time: 17:22:15
 */
public class RemoteShopBackdoorUrlServiceImpl
        extends AbstractRemoteService<ShopBackdoorUrlDTO>
        implements RemoteShopBackdoorUrlService {


    /**
     * Construct remote service.
     *
     * @param dtoShopBackdoorUrlService dto service to use
     */
    public RemoteShopBackdoorUrlServiceImpl(final DtoShopBackdoorUrlService dtoShopBackdoorUrlService) {
        super(dtoShopBackdoorUrlService);
    }
