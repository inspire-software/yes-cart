 ...
 * Time: 14:27
 */
public class PromotionImpexFederationFilterImpl extends AbstractImpexFederationFilterImpl implements FederationFilter {

    private final ShopFederationStrategy shopFederationStrategy;

    public PromotionImpexFederationFilterImpl(final ShopFederationStrategy shopFederationStrategy,
    ...
    public boolean isManageable(final Object object, final Class objectType) {
        ...
        return manageableShopIds.contains(promotion.getShopCode());
    }
