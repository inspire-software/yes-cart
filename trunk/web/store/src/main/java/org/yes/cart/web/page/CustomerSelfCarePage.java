...
public class CustomerSelfCarePage  extends AbstractWebPage {
    ...
    public CustomerSelfCarePage(final PageParameters params) {
       ...
       /* add( new CustomerOrderPanel(ORDERS_PANEL, customerModel));
        ...
        add( new ManageAddressesView(SHIPPING_ADDR_PANEL, customerModel, Address.ADDR_TYPE_SHIPING));

        add( new ManageAddressesView(BILLING_ADDR_PANEL, customerModel, Address.ADDR_TYPE_BILLING));
