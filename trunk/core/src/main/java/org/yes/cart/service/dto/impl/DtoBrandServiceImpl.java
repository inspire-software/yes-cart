...
public class DtoBrandServiceImpl
     ...
     * {@inheritDoc}
     */
    public BrandDTO create(final BrandDTO instance) throws UnmappedInterfaceException, UnableToCreateInstanceException {
        Brand brand = getEntityFactory().getByIface(Brand.class);
