...
INSERT INTO TATTRIBUTE (ATTRIBUTE_ID, GUID, CODE, MANDATORY, VAL, NAME, DESCRIPTION, ETYPE_ID, ATTRIBUTEGROUP_ID, GUID)
  VALUES (  10998,  'PRICE_NAVIGATION_STRATEGY',  'PRICE_NAVIGATION_STRATEGY',  0,  NULL,  'Price navigation strategy',  '[STATIC] or [DYNAMIC]. DYNAMIC allow create price tier dynamically for not default currency',  1004, 1001, 'PRICE_NAVIGATION_STRATEGY');
