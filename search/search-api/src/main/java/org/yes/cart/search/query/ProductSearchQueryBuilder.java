...
public interface ProductSearchQueryBuilder<T> extends SearchQueryBuilder<T> {
    ...
    String PRODUCT_MANUFACTURER_CODE_FIELD_SEARCH = "manufacturerCode_search";
    ...
    String SKU_PRODUCT_MANUFACTURER_CODE_FIELD_SEARCH = "sku.manufacturerCode_search";
    ...
    String BRAND_FIELD_SEARCH = "brand_search";
