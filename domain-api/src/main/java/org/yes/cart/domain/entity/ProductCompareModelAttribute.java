 ...
 * Time: 23:21
 */
public interface ProductCompareModelAttribute extends Serializable {
     ...
     * @return values
     */
    Map<String, List<ProductCompareModelValue>> getValues();

    /**
     * Get all values for given attribute (usually single value)
     *
     * @param code p_[ID] or s_[ID]
     *
     * @return values
     */
    List<ProductCompareModelValue> getValues(String code);
