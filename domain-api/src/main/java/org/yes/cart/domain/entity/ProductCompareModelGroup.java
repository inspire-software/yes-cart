 ...
 * Time: 23:21
 */
public interface ProductCompareModelGroup extends Serializable {
     ...
     * @return attributes
     */
    List<ProductCompareModelAttribute> getAttributes();
     ...
     * @return attribute
     */
    ProductCompareModelAttribute getAttribute(String code);
