 ...
 * Time: 11:13:01
 */
public interface MediaFileNameStrategy {
    ...
    /**
     * Get the internal media file relative path root directory ended with {@link java.io.File#separator}. E.g. "category/"
     *
     ...
     * Prefix - part of path to media repository.
     *
     * @param url given url
     ...
     *
     * @param url filename
     * @return code for given file name or null if particular strategy does not support code.
     */
     ...
     *
     * @param url filename
     * @return locale for given file name or null if no locale information can be extracted
     */
    ...
    /**
     * Get the file name in media repository.
     *
     *
     ...
     */
    String resolveRelativeInternalFileNamePath(String fileName, String code, String locale, String width, String height);
